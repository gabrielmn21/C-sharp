...
namespace Trabalho {
    ...
    public partial class Gabriel_BDDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nome, string Telefone, string CPF, string Email) {
...
namespace Trabalho.Gabriel_BDDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Usuarios] WHERE (([ID] = @Original_ID) AND ([Nome] = @Original_Nome)" +
                " AND ([Telefone] = @Original_Telefone) AND ([CPF] = @Original_CPF) AND ([Email] " +
                "= @Original_Email))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuarios] ([Nome], [Telefone], [CPF], [Email]) VALUES (@Nome, @Telef" +
                "one, @CPF, @Email);\r\nSELECT ID, Nome, Telefone, CPF, Email FROM Usuarios WHERE (" +
                "ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Usuarios] SET [Nome] = @Nome, [Telefone] = @Telefone, [CPF] = @CPF, [Email] = @Email WHERE (([ID] = @Original_ID) AND ([Nome] = @Original_Nome) AND ([Telefone] = @Original_Telefone) AND ([CPF] = @Original_CPF) AND ([Email] = @Original_Email));
SELECT ID, Nome, Telefone, CPF, Email FROM Usuarios WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Trabalho.Properties.Settings.Default.Gabriel_BDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, Nome, Telefone, CPF, Email\r\nFROM            Usuarios";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT CPF, Email, ID, Nome, Telefone FROM Usuarios";
        ...
        public virtual int Fill(Gabriel_BDDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual Gabriel_BDDataSet.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Gabriel_BDDataSet.UsuariosDataTable dataTable = new Gabriel_BDDataSet.UsuariosDataTable();
        ...
        public virtual int FillBy(Gabriel_BDDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual Gabriel_BDDataSet.UsuariosDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            Gabriel_BDDataSet.UsuariosDataTable dataTable = new Gabriel_BDDataSet.UsuariosDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Gabriel_BDDataSet.UsuariosDataTable dataTable) {
